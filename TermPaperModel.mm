...
- (void)exportDocxFile
{
	...
	status = zipWriteInFileInZip(zipFileHandle, [relsData bytes], [relsData length]);
	NSLog(@"status = %d", status);
	...
	status = zipWriteInFileInZip(zipFileHandle, [contentTypesData bytes], [contentTypesData length]);
	NSLog(@"status = %d", status);
	status = zipCloseFileInZip(zipFileHandle);
	NSLog(@"status = %d", status);
	// app.xml
	...
	status = zipWriteInFileInZip(zipFileHandle, [appData bytes], [appData length]);
	NSLog(@"status = %d", status);
	status = zipCloseFileInZip(zipFileHandle);
	NSLog(@"status = %d", status);
	// core.xml
	...
	status = zipWriteInFileInZip(zipFileHandle, [coreData bytes], [coreData length]);
	NSLog(@"status = %d", status);
	status = zipCloseFileInZip(zipFileHandle);
	NSLog(@"status = %d", status);
	// meta.xml
	...
	status = zipWriteInFileInZip(zipFileHandle, [metaData bytes], [metaData length]);
	NSLog(@"status = %d", status);
	status = zipCloseFileInZip(zipFileHandle);
	NSLog(@"status = %d", status);
	// document.xml.rels
	...
	status = zipWriteInFileInZip(zipFileHandle, [rels2Data bytes], [rels2Data length]);
	NSLog(@"status = %d", status);
	status = zipCloseFileInZip(zipFileHandle);
	NSLog(@"status = %d", status);
	// document.xml
...
//	NSLog(@"docxString = %@", docxString);
	...
	status = zipWriteInFileInZip(zipFileHandle, string, docxString.length);
	NSLog(@"status = %d", status);
	status = zipCloseFileInZip(zipFileHandle);
	NSLog(@"status = %d", status);
	...
	status = zipWriteInFileInZip(zipFileHandle, [header1Data bytes], [header1Data length]);
	NSLog(@"status = %d", status);
	status = zipCloseFileInZip(zipFileHandle);
	NSLog(@"status = %d", status);
	...
	status = zipWriteInFileInZip(zipFileHandle, [header2Data bytes], [header2Data length]);
	NSLog(@"status = %d", status);
	status = zipCloseFileInZip(zipFileHandle);
	NSLog(@"status = %d", status);
	...
	status = zipWriteInFileInZip(zipFileHandle, [themeData bytes], [themeData length]);
	NSLog(@"status = %d", status);
	status = zipCloseFileInZip(zipFileHandle);
	NSLog(@"status = %d", status);
